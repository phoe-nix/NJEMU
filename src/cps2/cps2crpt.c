...
static void cps2_decrypt(const uint32_t *master_key, uint32_t upper_limit)
{
	uint16_t *rom = (uint16_t *)memory_region_cpu1;
	uint32_t length = memory_length_user1;
	uint16_t *dec = (uint16_t *)memory_region_user1;
	uint32_t i, percent = 0, prev_percent = 0;
	uint32_t key1[4];
