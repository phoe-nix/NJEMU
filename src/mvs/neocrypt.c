...
#endif
	int i, j, k;
	static const int sec[]={0x000000,0x100000,0x000004,0x100004,0x10000a,0x00000a,0x10000e,0x00000e};
	static const int pos[]={0x000,0x004,0x00a,0x00e};
...
static int UINT16 generate_cs16(UINT8 *rom, int size)
{
	UINT16 cs16;
	int i;
	cs16 = 0x0000;
...
int neogeo_cmc50_m1_decrypt(void)
{
	...
	UINT8 *rom2 = (UINT8 *)memory_region_cpu2;
#ifdef PSP_SLIM
	UINT8 *buffer = (UINT8 *)psp2k_mem_offset;
#else
